...
LDFLAGS  := -s -w \
	...
	-X '$(PKG)/internal/cli/issue.ServiceCertDefaultConcatIntermediateCert=$(ISSUE_DEFAULT_SERVICECERT_CONCAT_INTERMEDIATE_CERT)' \
	-X '$(PKG)/internal/cli/issue.ServiceCertDefaultExpiryTime=$(ISSUE_DEFAULT_SERVICECERT_EXPIRY_TIME)' \
	-X '$(PKG)/internal/cli/issue.ServiceCertDefaultIP=$(ISSUE_DEFAULT_SERVICECERT_IP)' \
	-X '$(PKG)/internal/cli/issue.ServiceCertDefaultSignerKeyID=$(ISSUE_DEFAULT_SERVICECERT_SIGNER_KEY_ID)' \
